...
#include <cstring>
#include <iostream>
//#include "/usr/local/pgsql/pgsql101/include/libpq-fe.h" // 2018-07-10T14:27:32 not needed. this class \
does not interface with postgres
...
void  alignSetup(const char *, int=ASSUMEDBUFFERSIZE);
